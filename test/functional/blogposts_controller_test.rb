...
class BlogpostsControllerTest < ActionController::TestCase
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post :create, blogpost: { content: @blogpost.content, date_created: @blogpost.date_created, name: @blogpost.name, title: @blogpost.title }
    end
  ...
  test "should update blogpost" do
    put :update, id: @blogpost, blogpost: { content: @blogpost.content, date_created: @blogpost.date_created, name: @blogpost.name, title: @blogpost.title }
    assert_redirected_to blogpost_path(assigns(:blogpost))
  end
